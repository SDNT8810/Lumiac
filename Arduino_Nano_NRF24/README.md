...
- `Octopus_Board`: Nano receiver using NRF24, serial to Octopus, and hardware reset recovery
...
- lamp control delegated to Marlin with `M355` on the configured Octopus bed/heater output
