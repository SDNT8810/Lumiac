...
#define STRING_CONFIG_H_AUTHOR "(OpenAI, Octopus v1.1 6-axis spider)" // Who made the changes.
...
// Explicit 6-axis motor mapping on the Octopus:
// X=MOTOR0, Y=MOTOR1, Z=MOTOR2, A=MOTOR3, B=MOTOR4, C=MOTOR5
...
#define BAUDRATE_2 115200   // ESP bridge on Octopus WIFI header (PD8/PD9)
...
#define CUSTOM_MACHINE_NAME "Hexapod Spider"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 80, 80, 80, 80, 80, 80 }
...
#define Z_HOMING_HEIGHT  0      // Don't raise Z before lateral homing moves.
...
#define I_MIN_POS 0
#define I_MAX_POS 120
#define J_MIN_POS 0
#define J_MAX_POS 120
#define K_MIN_POS 0
#define K_MAX_POS 120
//#define W_MIN_POS 0
//#define W_MAX_POS 50
