...
public:
  ...
  static bool interactive_sd_job;
  static bool interactive_sd_loop;
  static char interactive_sd_path[MAXPATHNAMELENGTH],
              filename[FILENAME_LENGTH],            // DOS 8.3 filename of the selected item
  ...
  static void configureInteractiveJob(const bool state, const bool loop=false, const char * const path=nullptr);
  static void setInteractiveJob(const bool state) { configureInteractiveJob(state); }
  static bool isInteractiveJob() { return interactive_sd_job; }
  static bool isInteractiveLoopJob() { return interactive_sd_job && interactive_sd_loop && interactive_sd_path[0]; }
