    ...
    <div class="app-shell">
      <section class="panel panel-left">
        <div class="panel-head">
          ...
          <p class="muted">Access-point control page for Octopus serial G-code, shared light control, NRF remote commands, and live robot state.</p>
          <div class="chip-row">
        ...
        <div class="card feed-card">
          ...
          <p class="muted">PWM output is generated on ESP_NRF and shared between the browser UI and the NRF remote.</p>
        </div>
        ...
        <div class="card status-card">
          ...
          <p id="networkLine" class="muted" style="margin-top: 8px;">AP: 192.168.4.1 · Remote: NRF24</p>
        </div>
      </section>
      ...
      function connectWebSocket() {
        ...
        ws.addEventListener("message", (event) => {
          ...
          if (payload.type === "state") {
            ...
            const remoteIp = payload.remoteIp ?? "NRF24";
